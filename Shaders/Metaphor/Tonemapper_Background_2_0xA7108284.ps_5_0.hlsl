	...
	out float4 o0 : SV_Target0)
{
	...
	r0.xyzw = sample_bicubic(bloomTexture, bloomSampler_s, v1.xy);
	...
	if (r1.w == 0)
	{
		...
		{
			float3 corrected_bt709 = mul(ACES::BT709_TO_AP0_MAT, r2.rgb);
